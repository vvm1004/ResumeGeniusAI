...
export class ResumeBuilder {
    ...
    @Prop([{ degree: String, major: String, institution: String, gpa: String, date: String }])
    education: Array<any>;

    @Prop([{ title: String, description: String, features: String, technologies: String, githubLink: String, demo: String, date: String, tool: String }])
    projects: Array<any>;

    @Prop([{ title: String, organization: String, date: String, description: String, role: String, achievements: [String] }])
    ...
    @Prop([{ name: String, position: String, organization: String, contact: String }])
