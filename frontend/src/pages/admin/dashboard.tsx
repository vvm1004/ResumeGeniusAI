...
// import LineCharts from "@/components/admin/dashboard/PieChart";
...
//           <Row gutter={[20, 20]} >
//             <Col span={24} >
//               <Card style={{ height: '182px' }} title="Card Title 1" bordered={false}>
//                 <Statistic title="Active Users" value={112893} formatter={formatter} />
//               </Card>
//             </Col>
//             <Col span={24}>
//               <Card style={{ height: '182px' }}title="Card Title 2" bordered={false}>
//                 <Statistic title="New Signups" value={83716} formatter={formatter} />
//               </Card>
//             </Col>
//           </Row>
//         </Col>
...
//         <Col span={24} md={12}>
//           <Card title="Pie Chart" bordered={false} style={{ height: "100%" }}>
//               <PieCharts />
//           </Card>
//         </Col>
...
//         <Col span={24} md={12}>
//           <Card title="Geography Chart" bordered={false} style={{ height: "100%" }}>
//             <GeographyChart />
//           </Card>
//         </Col>
//       </Row>
