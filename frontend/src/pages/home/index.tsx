...
const resumeImages = [resume1, resume2, resume3, resume1, resume2, resume3];
const Home: React.FC = () => {
      ...
      <section className="title">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          ...
          <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            ...
            <a
              onClick={openModal}
              className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-300 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800"
            >
              Upgrade Resume
            </a>
          </div>
          ...
          <div className="home-resume-maker__header">
            ...
            <div className="home-resume-maker__header-content title-content">
              ...
              <div className="home-resume-maker__header-actions">
                ...
                <a
                  onClick={openModal}
                  className="inline-flex  ms-4 justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-300 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800"
                >
                  Upgrade Resume
                </a>
              </div>
            ...
            <div className="home-resume-maker__feature">
              ...
              <div className="home-resume-maker__feature-description">
                <p>
                  ...
                  experts. We help your resume become truly competitive in the
                  hiring process.
                </p>
              </div>
            </div>
