    ...
    return (
      ...
      width={1200} height={300} /> */}
         ...
         hover:border-pink-500/10 hover:shadow-pink-500/10"
            ...
            <div className="home-resume-maker section">
                        ...
                        <div className="home-resume-maker__header-content">
                            ...
                            <div className="home-resume-maker__header-actions">
                                ...
                                <button
                                    ...
                                    data-iframe-src="https://www.youtube.com/embed/ySZgLHbK0Gg?autoplay=1"
                                >
                                    <svg
                                    ...
                                    >
                                        <path d="M1.5.9a1 1 0 00-1.5.8v10.6a1 1 0 001.5.8l9-5.2a1 1 0 000-1.8L1.5 1z" />
                                    </svg>
                                    Watch video
                                </button>
                            </div>
