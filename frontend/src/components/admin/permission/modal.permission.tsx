...
const ModalPermission = (props: IProps) => {
    ...
    const submitPermission = async (valuesForm: any) => {
        ...
        if (dataInit?._id) {
            ...
            if (res.data) {
                message.success("Permission update successful");
                handleReset();
                reloadTable();
            } else {
                notification.error({
            ...
            if (res.data) {
                message.success("New permission added successfully");
                handleReset();
                reloadTable();
            } else {
                notification.error({
    ...
    return (
        <>
            <ModalForm
                title={<>{dataInit?._id ? "Update Permission" : "Create New Permission"}</>}
                open={openModal}
                modalProps={{
